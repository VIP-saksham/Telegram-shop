...
from .entry_gate import router as entry_gate_router
from .upi_payment import router as upi_payment_router

from aiogram import Router

router = Router()
router.include_router(main_router)
router.include_router(entry_gate_router)
router.include_router(balance_and_payment_router)
router.include_router(upi_payment_router)
