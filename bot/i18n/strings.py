...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        # === Admin: Main Menu ===
        "admin.menu.main": "Панель администратора",
        ...
        "admin.users.cannot_touch_sudo": "Sudo-пользователя изменить нельзя",
        ...
        "admin.users.cannot_block_sudo": "Sudo-пользователя заблокировать нельзя",
        "admin.users.status.blocked": "<b>Статус</b> — Заблокирован",

        # === Admin: Shop Management Menu ===
        "admin.shop.menu.title": "Меню управления магазином",
        ...
        "admin.categories.menu.title": "Меню управления категориями",
        ...
        "admin.goods.add.name.invalid": "Недопустимое название (1–100 символов, без управляющих символов).",
        ...
        "admin.goods.add.result.skipped_db_dup": "Пропущено (уже были в БД): <b>{n}</b>",
        ...
        "admin.goods.menu.title": "Меню управления позициями",
        ...
        "admin.sale.current.active": "Текущая скидка: <b>{percent}%</b> до <b>{until}</b> (UTC).",
        "admin.sale.current.none": "Сейчас на этой позиции скидки нет.",
        "admin.sale.prompt.percent": "Введите процент скидки (1–100).\nОтправьте <b>0</b>, чтобы убрать скидку.",
        "admin.sale.percent.invalid": "Некорректный процент. Введите целое число от 0 до 100.",
        ...
        "admin.sale.days.invalid": "Некорректный срок. Введите целое число дней больше 0.",
        ...
        "admin.shop.logs.empty": "Логов пока нет",
        "admin.shop.logs.too_large": "Логи слишком велики для отправки ({files}) — забирайте их с диска.",
        ...
        "shop.out_of_stock_all": "Пока пусто — товары скоро добавим. Загляни чуть позже!",
        ...
        "shop.item.quantity_left": "Stock: {count} pcs",
        ...
        "admin.promo.binding.dangling": "привязка удалена — промокод ни к чему не применяется",
        ...
        "cart.item_promo_elsewhere": "⚠️ <b>{name}</b> ×{qty} — {price} {currency}\n    промокод {code} уже использован на другой позиции",
        ...
        "btn.leaderboard": "Лидеры",
        "btn.help": "Помощь",
        "btn.language": "Язык",
        "btn.share_link": "Поделиться",
        "btn.copy_link": "Копировать",
        "btn.pay.upi": "Оплата UPI (INR)",
        "btn.help.how_buy": "Как купить",
        "btn.help.topup": "Пополнить баланс",
        "btn.help.policy": "Правила",
        "gate.title": "Проверка",
        "gate.join_hint": "Для доступа к боту подпишитесь на канал(ы) ниже, затем нажмите \"Проверить\".",
        "gate.check_joined": "Я подписался — проверить",
        "gate.captcha_prompt": "Подтвердите, что вы человек: {a} + {b} = ?",
        "gate.captcha_hint": "Выберите правильный ответ, чтобы открыть бота.",
        "gate.captcha_ok": "Верно! Добро пожаловать.",
        "gate.captcha_wrong": "Неверно. Попробуйте ещё раз.",
        "gate.captcha_expired": "Время истекло, новая задачка.",
        "gate.captcha_another": "Другой пример",
        "gate.joined_ok": "Подписка подтверждена.",
        "gate.still_not_joined": "Вы ещё не подписались на канал(ы).",
        "gate.locked": "Ссылка не настроена — обратитесь в поддержку.",
        "upi.title": "Оплата UPI",
        "upi.amount_key": "Сумма",
        "upi.upi_key": "UPI ID",
        "upi.scan_hint": "Отсканируйте QR в любом UPI-приложении — сумма уже указана. Оплата строго на эту сумму.",
        "upi.utr_prompt": "Введите UTR / идентификатор транзакции (12 цифр):",
        "upi.utr_invalid": "UTR выглядит неверно — введите 8-22 символа (обычно 12 цифр).",
        "upi.screenshot_prompt": "Теперь пришлите скриншот оплаты одним сообщением.",
        "upi.submitted": "Скриншот отправлен на проверку. Баланс зачислим после подтверждения — обычно это занимает пару минут.",
        "upi.sent_no_room": "Принято! Проверка займёт немного времени — комната проверки не настроена, админ увидит заявку в логах.",
        "upi.credited": "✅ Платёж подтверждён: +{amount} {currency} на балансе.",
        "upi.rejected": "Заявка #{req} отклонена. Если считаете это ошибкой — напишите в поддержку.",
        "upi.review.title": "UPI-платёж на проверку",
        "upi.review.user": "Пользователь",
        "upi.review.username": "Юзернейм",
        "upi.review.amount": "Сумма",
        "upi.review.utr": "UTR",
        "upi.review.req": "Заявка",
        "upi.review.verify": "Verify ✔",
        "upi.review.deny": "Deny ✖",
        "upi.review.only_admins": "Только владелец/sudo могут подтверждать платежи.",
        "upi.review.approved": "Подтверждено — баланс зачислен.",
        "upi.review.denied": "Отклонено.",
        "upi.review.already_done": "Заявка уже обработана.",
        "upi.review.done": "Заявка #{req} обработана: +{amount}.",
        "invite.title": "Приглашай и зарабатывай",
        "invite.desc": "Приглашайте друзей и получайте реальный баланс за каждого — без ограничений по сумме заработка.",
        "invite.reward": "Награда за друга: {amount} {currency}",
        "invite.count": "Всего приглашено: {count}",
        "invite.earned": "Всего заработано: {amount} {currency}",
        "invite.link_label": "Ваша ссылка:",
        "invite.link": "<code>https://t.me/{bot_username}?start={user_id}</code>",
        "invite.share_hint": "Поделитесь ссылкой — награда придёт автоматически после проверки друга (капча).",
        "leaderboard.title": "Топ по приглашениям",
        "leaderboard.row": "{place}. {name} — {count} приглаш.",
        "leaderboard.empty": "Пока никто не приглашал друзей. Будьте первыми!",
        "help.title": "Помощь",
        "help.body": "Как купить: Магазин → выберите товар → Купить.\nКак пополнить: Кошелёк → Пополнить баланс → UPI/Stars/Crypto.\nОстались вопросы — жмите Поддержку в меню.",
        "help.tip": "Поддержка отвечает в меню — кнопка «Поддержка».",
        "language.title": "Выберите язык",
        "language.set": "Язык изменён: {lang}.",
        "policy.title": "Политика бота",
        "policy.body": "Нам важно ваше доверие: прозрачность, честность и надёжный сервис. Прочитайте перед покупкой.\n\n1️⃣ Возвраты\nПосле покупки средства не возвращаются. Если вы пополнили баланс, но ничего не купили — пополнение вернётся полностью.\n\n2️⃣ Гарантия\nТовары с указанной гарантией покрываются весь гарантийный срок: заменим услугу, компенсируем или вернём сумму на баланс.\n\n3️⃣ Бесплатные начисления\nБонусы с промокодов, рефералов и акций возврату не подлежат.\n\n4️⃣ Наша ответственность\nМы отвечаем за свои услуги и делаем всё для безопасной и стабильной работы.\n\n5️⃣ Наше обещание\nЧестность, прозрачность и справедливость — каждый день, для каждого клиента.\n\n🤝 Спасибо, что доверяете нам.",
        "rules.not_set": "Правила пока не заданы.",
        "admin.fc.title": "Force-join каналы",
        "admin.fc.add": "Добавить канал/группу",
        "admin.fc.added": "Канал добавлен в проверку.",
        "admin.fc.removed": "Канал убран из проверки.",
        "admin.fc.toggled": "Состояние канала изменено.",
        "admin.fc.bad_link": "Не понял ссылку. Пришлите t.me/ссылку или -100… id.",
        "admin.fc.menu": "Force-join каналы",
        "history.referral_bonus": "Бонус за друга: +{amount} {currency}",
        "history.hub_hint": "Выбери раздел: платежи, ваши товары или купоны.",
        "history.btn.payments": "Платежи",
        "history.btn.products": "Ваши товары",
        "history.btn.coupons": "История купонов",
        "history.coupons.title": "История купонов",
        "history.coupons.empty": "Вы ещё не использовали ни одного купона.",
        "history.coupons.row": "🎫 {code} — {amount} {currency} · {date}",
        "receipt.btn.send_proof": "Отправить proof",
        "receipt.btn.not_working": "Не работает",
        "receipt.btn.my_item": "Мой товар",
        "receipt.proof.prompt": "Пришлите скриншот (подтверждение покупки) — перешлём в поддержку.",
        "receipt.proof.to_room": "🧾 Proof от {user} (id {uid})",
        "receipt.proof.sent": "✅ Proof отправлен — поддержка скоро ответит.",
        "receipt.proof.no_room": "Комната поддержки не настроена — напишите администратору.",
        "receipt.proof.need_photo": "Пришлите, пожалуйста, изображение (скриншот).",
        "receipt.notworking.to_room": "⚠️ {user} (id {uid}): товар не работает — заказ #{order}",
        "receipt.notworking.sent": "Жалоба отправлена — разберёмся и компенсируем.",
        "buylog.public": "🛒 <b>Новая покупка!</b>\n\n📦 {item}\n💰 {price} {currency}\n👤 {user} · <code>{uid}</code>\n🧾 Заказ: <code>{order}</code>",
    },

    "hi": {
        "btn.shop": "Shop kholo",
        "menu.hello": "Namaste {name}!",
        "menu.start": "**{name}** me aapka swagat hai — digital goods ka trusted store.\nNeeche section chuno: purchase, balance aur history sab ek jagah.",
        "invite.reward_key": "Награда за друга",
    "invite.count_key": "Всего приглашено",
    "invite.earned_key": "Всего заработано",
    "invite.share_text": "Залетай в магазин — цифровые товары с моментальной выдачей!",
    "admin.fc.hint": "Yaha se force-join channel add karo — user ko jab tak join nahi karenge, bot nahi khulega.",
    "admin.fc.send_link": "Channel ka t.me link ya -100… id bhejo:",
    "admin.fc.exists": "Ye channel pehle se list me hai.",
    "shop.pick_category": "Category chuno — andar items aur prices hain.",
    "shop.out_of_stock_all": "Abhi yaha kuch nahi hai — jald products add honge. Thodi der baad dekho!",
    "shop.pick_product": "Товар выбери — карточка покажет цену и наличие.",
    ...
    "history.hub_hint": "Section chuno: payments, aapke products ya coupons.",
    "history.btn.payments": "Payments",
    "history.btn.products": "Aapke products",
    "history.btn.coupons": "Coupon history",
    "history.coupons.title": "Coupon history",
    "history.coupons.empty": "Abhi tak koi coupon use nahi kiya.",
    "history.coupons.row": "🎫 {code} — {amount} {currency} · {date}",
    "receipt.btn.send_proof": "Send proof",
    "receipt.btn.not_working": "Not working",
    "receipt.btn.my_item": "Mera item",
    "receipt.proof.prompt": "Screenshot bhejo (proof) — support ko forward karenge.",
    "receipt.proof.to_room": "🧾 Proof from {user} (id {uid})",
    "receipt.proof.sent": "✅ Proof bhej diya — support jaldi reply karega.",
    "receipt.proof.no_room": "Support room set nahi hai — admin se sampark karo.",
    "receipt.proof.need_photo": "Image (screenshot) bhejo please.",
    "receipt.notworking.to_room": "⚠️ {user} (id {uid}): item kaam nahi kar raha — order #{order}",
    "receipt.notworking.sent": "Report bhej di — dekh lenge, compensation milega.",
    "buylog.public": "🛒 <b>Nayi kharidari!</b>\n\n📦 {item}\n💰 {price} {currency}\n👤 {user} · <code>{uid}</code>\n🧾 Order: <code>{order}</code>",
},
...
"en": {
        ...
        "admin.users.cannot_touch_sudo": "A sudo user cannot be modified",
        ...
        "admin.users.cannot_block_sudo": "A sudo user cannot be blocked",
        "admin.users.status.blocked": "<b>Status</b> — Blocked",

        # === Admin: Shop Management Menu ===
        "admin.shop.menu.title": "Shop management",
        ...
        # === Admin: Categories Management ===
        "admin.categories.menu.title": "Categories management",
        ...
        "admin.goods.add.name.invalid": "Invalid name (1–100 characters, no control characters).",
        ...
        "admin.goods.add.result.skipped_db_dup": "Skipped (already in DB): <b>{n}</b>",
        ...
        "admin.goods.menu.title": "Items management menu",
        ...
        "admin.sale.current.active": "Current discount: <b>{percent}%</b> until <b>{until}</b> (UTC).",
        "admin.sale.current.none": "This item currently has no discount.",
        "admin.sale.prompt.percent": "Enter the discount percent (1–100).\nSend <b>0</b> to remove the discount.",
        "admin.sale.percent.invalid": "Invalid percent. Enter an integer from 0 to 100.",
        ...
        "admin.sale.days.invalid": "Invalid duration. Enter an integer number of days greater than 0.",
        ...
        "admin.shop.logs.empty": "No logs yet",
        "admin.shop.logs.too_large": "Logs are too large to send ({files}) — grab them from disk.",
        ...
        "admin.promo.binding.dangling": "binding deleted — this promo applies to nothing",
        ...
        "cart.item_promo_elsewhere": "⚠️ <b>{name}</b> ×{qty} — {price} {currency}\n    promo {code} was already used on another item",
    ...
    "btn.history": "History",
    "btn.invite": "Invite",
    "btn.leaderboard": "Leaders",
    "btn.help": "Help",
    "btn.language": "Language",
    "btn.share_link": "Share",
    "btn.copy_link": "Copy link",
    "btn.pay.upi": "UPI payment (INR)",
    "btn.help.how_buy": "How to buy",
    "btn.help.topup": "Top up balance",
    "btn.help.policy": "Policy",
    "gate.title": "Verification",
    "gate.join_hint": "To open the bot, join the channel(s) below, then press Check.",
    "gate.check_joined": "I have joined — check",
    "gate.captcha_prompt": "Prove you are human: {a} + {b} = ?",
    "gate.captcha_hint": "Pick the correct answer to unlock the bot.",
    "gate.captcha_ok": "Correct! Welcome.",
    "gate.captcha_wrong": "Wrong answer. Try again.",
    "gate.captcha_expired": "Time is up — here is a new puzzle.",
    "gate.captcha_another": "Another puzzle",
    "gate.joined_ok": "Subscription confirmed.",
    "gate.still_not_joined": "You have not joined the channel(s) yet.",
    "gate.locked": "Link is not configured — contact support.",
    "upi.title": "UPI payment",
    "upi.amount_key": "Amount",
    "upi.upi_key": "UPI ID",
    "upi.scan_hint": "Scan this QR with any UPI app — the amount is already fixed. Pay exactly this amount.",
    "upi.utr_prompt": "Enter the UTR / transaction reference (12 digits):",
    "upi.utr_invalid": "That UTR looks wrong — enter 8-22 characters (usually 12 digits).",
    "upi.screenshot_prompt": "Now send the payment screenshot as one message.",
    "upi.submitted": "Screenshot sent for review. We credit the balance after confirmation — usually a couple of minutes.",
    "upi.sent_no_room": "Got it! Review takes a moment — the review room is not configured, the admin will see the request in logs.",
    "upi.credited": "✅ Payment confirmed: +{amount} {currency} added to your balance.",
    "upi.rejected": "Request #{req} was rejected. If you think this is a mistake, contact support.",
    "upi.review.title": "UPI payment to review",
    "upi.review.user": "User",
    "upi.review.username": "Username",
    "upi.review.amount": "Amount",
    "upi.review.utr": "UTR",
    "upi.review.req": "Request",
    "upi.review.verify": "Verify ✔",
    "upi.review.deny": "Deny ✖",
    "upi.review.only_admins": "Only the owner/sudo can approve payments.",
    "upi.review.approved": "Approved — balance credited.",
    "upi.review.denied": "Denied.",
    "upi.review.already_done": "This request is already processed.",
    "upi.review.done": "Request #{req} processed: +{amount}.",
    "invite.title": "Invite and Earn",
    "invite.desc": "Invite friends and earn real wallet balance for every signup — no limit on how much you can earn.",
    "invite.reward": "Reward per referral: {amount} {currency}",
    "invite.count": "Your total referrals: {count}",
    "invite.earned": "Total earned: {amount} {currency}",
    "invite.link_label": "Your link:",
    "invite.link": "<code>https://t.me/{bot_username}?start={user_id}</code>",
    "invite.share_hint": "Share this link — when someone starts the bot through it and passes the check, your reward is credited automatically.",
    "leaderboard.title": "Top referrers",
    "leaderboard.row": "{place}. {name} — {count} invites",
    "leaderboard.empty": "Nobody has invited friends yet. Be the first!",
    "help.title": "Help",
    "help.body": "How to buy: Shop → pick a product → Buy.\nHow to top up: Wallet → Top up → UPI/Stars/Crypto.\nStill stuck? Hit Support in the menu.",
    "help.tip": "Support is one tap away — the Support button in the menu.",
    "language.title": "Choose language",
    "language.set": "Language set: {lang}.",
    "policy.title": "Bot Policy",
    "policy.body": "Your trust matters to us. We believe in transparency, fairness, and reliable service. Please read the following policy carefully before using our services.\n\n1️⃣ Refund Policy\nOnce a product is purchased, the deposited amount is non-refundable. However, if you deposit funds but do not purchase any product, the full amount will be refunded.\n\n2️⃣ Warranty Policy\nAll products with a mentioned warranty are covered during the specified warranty period. In case of an issue, we will replace the service and provide suitable compensation, or return the amount to your bot balance for another purchase.\n\n3️⃣ Free Credits\nCredits received through redeem codes, referrals, or promotional rewards are non-refundable.\n\n4️⃣ Our Commitment\nWe take full responsibility for our services and always strive to provide a safe, smooth, and reliable experience to every customer.\n\n5️⃣ Our Promise\nWe promise to remain honest, transparent, and fair while continuously working to provide you with the best service possible.\n\n🤝 Thank you for trusting us.",
    "rules.not_set": "Rules are not set yet.",
    "admin.fc.title": "Force-join channels",
    "admin.fc.add": "Add channel/group",
    "admin.fc.added": "Channel added to the gate.",
    "admin.fc.removed": "Channel removed from the gate.",
    "admin.fc.toggled": "Channel state changed.",
    "admin.fc.bad_link": "Could not parse that. Send a t.me/ link or a -100… id.",
    "admin.fc.menu": "Force-join channels",
    "history.referral_bonus": "Referral reward: +{amount} {currency}",
    "invite.reward_key": "Reward per referral",
    "invite.count_key": "Your total referrals",
    "invite.earned_key": "Total earned",
    "invite.share_text": "Join the store — digital goods with instant delivery!",
    "admin.fc.hint": "Add channels users must join before the bot opens. The bot should be an admin in each one.",
    "admin.fc.send_link": "Send the channel's t.me link or its -100… id:",
    "admin.fc.exists": "That channel is already on the list.",
    "shop.pick_category": "Pick a category — items and prices inside.",
    "shop.out_of_stock_all": "Nothing here yet — new products are being added. Check back soon!",
    "shop.pick_product": "Pick a product — the card shows price and stock.",
    "shop.goods.choose_cat": "Products: {category}",
    "upi.btn.send_utr": "Send UTR",
    "upi.btn.send_screenshot": "Send screenshot",
    "referral.credited_notify": "💰 Rs.{amount} credited in your account from referral {name}!",
    "history.hub_hint": "Pick a section: payments, your products or coupons.",
    "history.btn.payments": "Payments",
    "history.btn.products": "Your products",
    "history.btn.coupons": "Coupon history",
    "history.coupons.title": "Coupon history",
    "history.coupons.empty": "You haven't used a single coupon yet.",
    "history.coupons.row": "🎫 {code} — {amount} {currency} · {date}",
    "receipt.btn.send_proof": "Send proof",
    "receipt.btn.not_working": "Not working",
    "receipt.btn.my_item": "My item",
    "receipt.proof.prompt": "Send a screenshot (purchase proof) — we'll forward it to support.",
    "receipt.proof.to_room": "🧾 Proof from {user} (id {uid})",
    "receipt.proof.sent": "✅ Proof sent — support will get back to you shortly.",
    "receipt.proof.no_room": "Support room is not configured — contact the administrator.",
    "receipt.proof.need_photo": "Please send an image (screenshot).",
    "receipt.notworking.to_room": "⚠️ {user} (id {uid}): item not working — order #{order}",
    "receipt.notworking.sent": "Report sent — we'll investigate and compensate you.",
    "buylog.public": "🛒 <b>New purchase!</b>\n\n📦 {item}\n💰 {price} {currency}\n👤 {user} · <code>{uid}</code>\n🧾 Order: <code>{order}</code>",
},
}
