...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "shop.categories.title": "<b>Категории магазина</b>\n<i>Выберите категорию:</i>",
        "shop.goods.choose": "<b>Товары категории</b>\n<i>Выберите товар:</i>",
        ...
        "shop.item.title": "<b>Товар:</b> {name}",
        "shop.item.description": "<b>Описание:</b> {description}",
        "shop.item.price": "<b>Цена:</b> {amount} {currency}",
        "shop.item.quantity_unlimited": "<b>Количество:</b> неограниченно",
        "shop.item.quantity_left": "<b>Количество:</b> {count} шт.",
...
"en": {
        ...
        # === Shop Browsing (Categories / Goods / Item Page) ===
        "shop.categories.title": "<b>Shop categories</b>\n<i>Pick a category:</i>",
        ...
        "shop.goods.choose": "<b>Category items</b>\n<i>Pick a product:</i>",
        "shop.item.not_found": "Item not found",
        "shop.item.title": "<b>Item:</b> {name}",
        "shop.item.description": "<b>Description:</b> {description}",
        "shop.item.price": "<b>Price:</b> {amount} {currency}",
        "shop.item.quantity_unlimited": "<b>Quantity:</b> unlimited",
        "shop.item.quantity_left": "<b>Quantity:</b> {count} pcs",
